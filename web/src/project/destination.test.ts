...
describe("construct B from current Project state", () => {
  ...
  it("assigns constructed image and trusted media identity without changing A, C...N, or story", () => {
    ...
    expect(constructed.journeys.find((journey) => journey.id === "A-B")?.motionPlan).toBeUndefined();
...
describe("construct C from actual B", () => {
  ...
  it("gives C actual media without changing A, B, D...N, or story", () => {
    ...
    expect(constructed.journeys.find((journey) => journey.id === "A-B")?.status).toBe("rendered");
    expect(constructed.journeys.find((journey) => journey.id === "B-C")?.status).toBe("rendered");
    expect(constructed.journeys.find((journey) => journey.id === "B-C")?.cinematographer).toBeUndefined();
    expect(constructed.journeys.find((journey) => journey.id === "C-D")?.status).toBe("rendered");
    expect(constructed.journeys.find((journey) => journey.id === "C-D")?.videoUrl).toBe(
      actualB.journeys.find((journey) => journey.id === "C-D")?.videoUrl,
    );
