...
AGENT first pass: CREATE JOURNEY in Agent mode runs JourneyAgent over that same pipeline: sequential canonical construction, CM evaluation, Traversal-Confidence repair, Camotion, overlapping NEW TAKE, assembly of selected Takes. The filmmaker remains the authority over footage quality. The earlier research loop remains:
